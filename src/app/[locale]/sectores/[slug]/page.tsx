...
// Módulos recomendados por sector.
const RECOMMENDED: Record<string, string[]> = {
  'vehiculos-particulares': ['IRON Track', 'IRON Cell'],
  'flotas-de-carga': ['IRON Track', 'IRON Fleet'],
  'vehiculos-comerciales': ['IRON Track', 'IRON Macros'],
  'flotas-empresariales': ['IRON Fleet', 'IRON Analytics'],
  'transporte-logistica': ['IRON Track', 'IRON View'],
  'activos-maquinaria': ['IRON Track', 'IRON Fleet'],
  'seguridad-privada': ['IRON Cell', 'IRON View'],
  'construccion': ['IRON Track', 'IRON Inspect'],
  'agroindustria': ['IRON Fuel', 'IRON View'],
  'retail-centros-comerciales': ['IRON Track', 'IRON Analytics'],
};
...
const CAPS: Record<string, IconName[]> = {
  ...
  'seguridad-privada': ['shield', 'bell', 'lock', 'pin'],
  'construccion': ['factory', 'pin', 'box', 'bell'],
  'agroindustria': ['leaf', 'pulse', 'pin', 'chart'],
  'retail-centros-comerciales': ['store', 'video', 'route', 'chart'],
};
