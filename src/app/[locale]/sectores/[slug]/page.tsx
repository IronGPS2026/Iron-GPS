...
// Soluciones recomendadas por sector (referencia a los productos reales).
const RECOMMENDED: Record<string, string[]> = {
  ...
  'seguridad-privada': ['IRON SECURE', 'IRON SAFE'],
  'construccion': ['IRON TRACK', 'IRON CONNECT'],
  'agroindustria': ['IRON CONTROL', 'IRON VISION'],
  'retail-centros-comerciales': ['IRON CONTROL', 'IRON VISION'],
  'condominios': ['IRON SMART', 'IRON CONNECT'],
  'sector-publico': ['IRON SAFE', 'IRON CONNECT'],
};
...
const CAPS: Record<string, IconName[]> = {
  ...
  'condominios': ['home', 'lock', 'video', 'bell'],
  'sector-publico': ['siren', 'pin', 'video', 'user'],
};
