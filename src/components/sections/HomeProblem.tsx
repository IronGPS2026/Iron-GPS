  ...
  return (
    <section className="sec sec-white" id="problema">
      <div className="container-wrap">
        ...
        <div className="problem-intro-split">
          ...
          <Reveal delay={0.08} className="problem-photo">
            <Image src="/images/fleet-lineup.jpg" alt="" fill sizes="(max-width: 860px) 100vw, 480px" style={{ objectFit: 'cover' }} />
          </Reveal>
        </div>
      ...
      <style>{`
        ...
        .problem-photo { position: relative; height: 260px; border-radius: 16px; overflow: hidden; }
        @media (max-width: 860px) { .problem-intro-split { grid-template-columns: 1fr; } .problem-photo { order: -1; height: 220px; } }
