  ...
  return (
    <section className="sec sec-dark" id="seguridad">
        ...
        <div className="split">
          ...
          <Reveal delay={0.1} className="split-media">
            ...
            <div className="sec-photo-strip">
              <div className="sec-photo"><Image src="/images/ops-center.jpg" alt="" fill sizes="(max-width: 640px) 50vw, 280px" style={{ objectFit: 'cover' }} /></div>
              <div className="sec-photo"><Image src="/images/dashcam.jpg" alt="" fill sizes="(max-width: 640px) 50vw, 280px" style={{ objectFit: 'cover' }} /></div>
            </div>
          </Reveal>
        </div>
      </div>
      ...
      <style>{`
        ...
        .sec-photo { position: relative; height: 140px; border-radius: 12px; overflow: hidden; border: 1px solid rgba(255,255,255,.1); }
        @media (max-width: 640px) { .sec-photo { height: 110px; } }
      `}</style>
    </section>
  );
}
