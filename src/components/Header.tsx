  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        @media (max-width: 720px) { .hide-sm { display: none; } .brand-sub { display: none; } .hd-inner { height: 66px; } .site.shrink .hd-inner { height: 58px; } }
        @media (max-width: 520px) { .tb-inner { font-size: 10.5px; } .tb-right { gap: 12px; } }
        @media (max-width: 400px) { .tb-right a:last-child { display: none; } }
